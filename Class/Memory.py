...
class Memory:
    def __init__(self, canvas, x, y, size):
        ...
        self.size = size
        self.instruction_memory = [''] * (size // 2)  # Memoria de instrucciones
        self.data_memory = {i: Register(canvas, x, y + i * 20 - size // 2 * 20, i)
                            for i in range(size // 2, size)}  # Memoria de datos
    ...
    # Parámetros:
    # - address: Dirección de memoria en la cual almacenar el dato.
